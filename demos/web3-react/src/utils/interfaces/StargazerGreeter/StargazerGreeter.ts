...
export interface StargazerGreeterInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'setGreeting', values: [BigNumberish]): string;
...
export interface StargazerGreeter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StargazerGreeterInterface;
  ...
  callStatic: {
    ...
    setGreeting(_greetingId: BigNumberish, overrides?: CallOverrides): Promise<void>;
  };
